...
<!-- content -->
	<div id="content">
            ...
            <?php echo form_open('pages/family', 'id="reservation-form"')?>
            <form action="" id="reservation-form">
                
                <p> SSN:&nbsp;&nbsp; <input type="fssn" name="ssn" value="" maxlength="9" > 
                Number of Childred:&nbsp;&nbsp; <input type="text" name="child" value="" maxlength="5" ></p>
                
                <p>Number of Adults:&nbsp;&nbsp; <input type="text" name="adult" value="" maxlength="5" >  </p>
