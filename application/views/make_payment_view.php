...
<!-- content -->
	<div id="content">
            ...
            <?php echo form_open('pages/pay', 'id="reservation-form"')?>
            
                <form action="" id="reservation-form">
                
                <p> You have to pay:&nbsp;&nbsp;<?=$sum1+$sum2+$sum3; ?> $</p>
                <p>Enter SSN:&nbsp;&nbsp; <input type="text" name="ssn" value="" maxlength="9" >&nbsp;&nbsp;
                Amount:&nbsp;&nbsp; <input type="text" name="amount" value="" maxlength="5" >  &nbsp;&nbsp;
                Type:  <select class="select2" name="type">
                            <option value="Cash" >Cash</option>
                            <option value="Card" >Card</option>
                            </select> &nbsp;&nbsp;
                
                Date: &nbsp;&nbsp; <input type="text" name="date" value="" maxlength="10" ></p>
